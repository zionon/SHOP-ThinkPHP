...
/**************************请求参数**************************/
        ...
        $notify_url = "http://www.39.com/index.php/Home/Order/orderReceive";
        //需http://格式的完整路径，不能加?id=123这类自定义参数

        //页面跳转同步通知页面路径 ： 支付成功之后跳转的页面
        $return_url = "http://www.39.com/index.php/Home/Order/paySuccess";
        ...
        //订单名称
        $subject = 'SHOP-ThinkPHP网定单名称-'.$orderId;
        //必填
        ...
        $body = 'SHOP-ThinkPHP网定单名称-'.$orderId;
