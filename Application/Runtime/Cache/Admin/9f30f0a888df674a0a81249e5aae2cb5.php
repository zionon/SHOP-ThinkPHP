...
<div class="form-div search_form_div">
    <form action="/index.php/Admin/Attribute/attributeList" method="GET" name="search_form">
		<p>
			属性名称：
	...
	<table cellpadding="3" cellspacing="1">
		...
		<?php foreach ($data as $k => $v): ?>            
			<tr class="tron">
		        ...
		        <td align="center">
		        	<a href="<?php echo U('attributeEdit?id='.$v['id'].'&p='.I('get.p').'&type_id='.I('get.type_id')); ?>" title="编辑">编辑</a> |
